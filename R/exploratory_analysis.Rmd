---
title: "Covid Fiscal Measures (Exploratory Analysis)"
...
# GDP, Above-the-line measures (ALM), and poverty

## Correlation matrix

```{r echo=FALSE, message=FALSE, warning=FALSE}
Plots[["ALM_Poverty_Corrplot"]]
```

## Poverty under $1.90, ALM, and GDP

```{r echo=FALSE, message=FALSE, warning=FALSE}
Plots[["ALM_Poverty190"]]
```

## Poverty under $3.20, ALM, and GDP

```{r echo=FALSE, message=FALSE, warning=FALSE}
Plots[["ALM_Poverty320"]]
```

# GDP, Above-the-line measures (ALM), and inequality

## Correlation matrix

```{r echo=FALSE, message=FALSE, warning=FALSE}
Plots[["ALM_Gini_Corrplot"]]
```

## Gini Index, ALM, and GDP
